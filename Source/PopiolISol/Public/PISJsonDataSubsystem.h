...
public:
 ...
 UFUNCTION(BlueprintCallable, Category="Data") bool HasId(const FString& Id) const;
 UFUNCTION(BlueprintCallable, Category="Data") FString GetValidationReport() const { return ValidationReport; }
 UFUNCTION(BlueprintCallable, Category="Data") bool ReloadAndValidate();
